...
/**
 * Demonstrates EVERY lifecycle hook available on a Spring bean,
 * in the exact order Spring invokes them.
 */
public class LifecycleBean
    ...
    public LifecycleBean() {
        log("1  [Constructor]        Bean instantiated");
    }
    ...
    public void postConstruct() {
        log("7  [@PostConstruct]     JSR-250 init, preferred approach");
    }
    ...
    public void preDestroy() {
        log("12 [@PreDestroy]        JSR-250 cleanup, preferred approach");
    }

    // ── 13. DisposableBean ────────────────────────────────────────────────────
    @Override
    public void destroy() {
        log("13 [DisposableBean]     destroy()");
    }
